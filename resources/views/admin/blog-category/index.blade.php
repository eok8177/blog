...
<div class="card">
  <div class="card-header bg-light d-sm-flex justify-content-between align-items-center">
    ...
    <div class="pagination">
      {{ $categories->appends(request()->except('page'))->links('admin.include.pagination') }}
    </div>
        ...
        @foreach($categories as $category)
          <tr>
            ...
            <td class="text-start text-nowrap" width="1%">
              ...
              <a href="{{route('admin.blog-category.destroy',$category)}}" class="delete btn btn-sm text-danger ms-3">
